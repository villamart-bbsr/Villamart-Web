...
export default function CircularSlider() {
  ...
  useEffect(() => {
    const imageUrls = [
      "/images/fruits/fruits-1.webp",
      "/images/fruits/fruits-2.jpg",
      "/images/fruits/fruits-3.png",
      "/images/fruits/fruits-4.webp",
      "/images/fruits/fruits-5.webp",
      "/images/fruits/fruits-6.png",
