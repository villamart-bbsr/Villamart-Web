...
export default function CircularSlider() {
  ...
  useEffect(() => {
    const imageUrls = [
      "/images/grains/grains-1.jpg",
      "/images/grains/grains-2.webp",
      "/images/grains/grains-3.jpg",
      "/images/grains/grains-4.jpg",
      "/images/grains/grains-5.png",
      "/images/grains/grains-6.png",
    ]
